...
export default class HsvColorPicker extends Component {
  ...
  componentDidUpdate = (prevProps) => {
    if(prevProps.hue !== this.props.hue) {
      console.log('colorPicker hue props updated')
    }
  }
...
HsvColorPicker.propTypes = {
  ...
  huePickerContainerStyle: PropTypes.object,
  ...
  satValPickerContainerStyle: PropTypes.object,
...
HsvColorPicker.defaultProps = {
  ...
  huePickerHue: 0,
  huePickerBarWidth: 217,
  huePickerBarHeight: 30,
  huePickerSliderSize: 28,
